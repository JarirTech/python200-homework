...
cel_0 = celsius_to_fahrenheit(0)
cel_100 = celsius_to_fahrenheit(100)
cel_neg_40 = celsius_to_fahrenheit(-40)
print('Temperature of : ', celsius_to_fahrenheit(0))
print('Temperature of : ',  celsius_to_fahrenheit(100))
print('Temperature of : ', celsius_to_fahrenheit(-40))
#######################################################################
# Q2
print('====== Q2===========================================================')
...
def run_agent(user_prompt: str) -> str:
    ...
    SYSTEM_PROMPT = '''You are a simple assistant that can useuser asks about the time.'''
...
# I think run_agent() won't be able to convert 100 c to F and will not call any tool as long as
# the user not asking about time 

# Also I think only 1 Api will be called(the only one that let the module decide if  requested any tools )
#and as long as no tool needed he will return an answer.
...
resources_dir = Path(
    "C:\\Users\\bjari\\OneDrive\\Desktop\\python-200\\lessons\\07_AI_agents\\resources"
)
...
# ToolCallingAgent could not make the plot
# because it only uses available tools.

# CodeAgent tried writing its own code,
# so it was more flexible but made errors too.

# ToolCallingAgent is safer.
# CodeAgent is more powerful for harder tasks.
...
print('====== Q9===========================================================')
# ToolCallingAgent is better for simple
# and safe tasks using fixed tools.

# CodeAgent can create and run code,
# so it may cause errors or unsafe behavior.
