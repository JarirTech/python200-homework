...
"""
    ...
    try:
        ...
        for item in results["resume_bullets"]:
...
# These bullets are weak because they are vague and do not
# clearly show achievements, impact, or measurable results.
# The rewritten versions improve clarity, professionalism,
...
# user does not review it carefully.## One important guardrail is reminding users to always 
