...
#requirements:pip install openai pypdf python-dotenv "llama-index-core==0.14.10" llama-index-embeddings-openai
...
# in scenario B the team should use fine_tuning approch as long as they have around 3000 pdfs. They need to train 
# their module on a part of this documents.
...
# the system  by mistake chose hiring and loyalty documents because there was "your" overlap
...
# vector embeding is technique that convert the text into a binary code
...
# cosine similarity is usually between -1, and 1. if a number is close to 1 is the most relevant  so 0.85 score is the best
# chunk  here
...
documents_data = SimpleDirectoryReader("C:\\Users\\bjari\\OneDrive\\Desktop\\python-200\\lessons\\06_AI_augmentation\\resources\\brightleaf_pdfs").load_data()
