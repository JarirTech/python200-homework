...
#Pandas Question 1
# the following DataFrame and print the first three rows,
#  the shape, and the data types of each column.
...
#------------------------------------------------------------------------------
#Pandas Question 2
#Using the DataFrame from Q1, filter the rows to show only students who passed
#  and have a grade above 80.
#  Print the result.
filtred_rows = df[(df['grade'] > 80) & (df['passed']==True)]
print(f" the filtred_rows are: \n{filtred_rows}")
#-------------------------------------------------------------------------------
#Question 3
